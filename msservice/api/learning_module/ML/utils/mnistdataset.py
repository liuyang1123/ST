...
class MNISTDataset(Dataset):
    ...
    def _process(self):
        train_images = self._extract_images(self.workdir+self.filenames["TRAIN_IMAGES"])
        train_labels = self._extract_labels(self.workdir+self.filenames["TRAIN_LABELS"], one_hot=self.one_hot)
        self.train = [train_images[self.validation_size:],
                      train_labels[self.validation_size:]]

        test_images = self._extract_images(self.workdir+self.filenames["TEST_IMAGES"])
        test_labels = self._extract_labels(self.workdir+self.filenames["TEST_LABELS"], one_hot=self.one_hot)
